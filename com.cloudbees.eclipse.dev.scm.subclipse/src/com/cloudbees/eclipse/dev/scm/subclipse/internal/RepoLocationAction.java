 ...
 *******************************************************************************/
package com.cloudbees.eclipse.dev.scm.subclipse.internal;
...
import com.cloudbees.eclipse.dev.scm.subclipse.CloudBeesScmSubclipsePlugin;
import com.cloudbees.eclipse.dev.scm.subclipse.ForgeSubclipseSync;
    ...
    org.eclipse.core.runtime.jobs.Job job = new org.eclipse.core.runtime.jobs.Job("Importing location "+fi.url) {
      ...
      protected IStatus run(final IProgressMonitor monitor) {
        ...
        try {
          ...
          if (ForgeSubclipseSync.internalSync(fi, monitor)) {
            CloudBeesUIPlugin.getDefault().showView("org.tigris.subversion.subclipse.ui.repository.RepositoriesView");
          ...
          return new Status(IStatus.ERROR, CloudBeesScmSubclipsePlugin.PLUGIN_ID, 0, msg, e);
        } finally {
          monitor.done();
        }
      }
