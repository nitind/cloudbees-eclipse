...
public class NectarInstanceCodecTest {
  ...
  public void testCodec() {
    ...
    NectarInstance i1 = new NectarInstance("123", "label1", "url1", "username1", "password1", true);
    NectarInstance i2 = new NectarInstance("456", "label2", "url2", null, null, false);
    NectarInstance i3 = new NectarInstance("789", "label3", "url3", "username3", "", true);
    list.add(i1);
    list.add(i2);
    list.add(i3);
