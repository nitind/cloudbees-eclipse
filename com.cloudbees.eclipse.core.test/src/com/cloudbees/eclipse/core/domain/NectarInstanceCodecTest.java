...
public class NectarInstanceCodecTest {
  ...
  public void testCodec() {
    ...
    NectarInstance i1 = new NectarInstance("label1", "url1", "username1", "password1", true, false);
    NectarInstance i2 = new NectarInstance("label2", "url2", null, null, false, false);
    NectarInstance i3 = new NectarInstance("label3", "url3", "username3", "", true, false);
    list.add(i1);
    list.add(i2);
    list.add(i3);
