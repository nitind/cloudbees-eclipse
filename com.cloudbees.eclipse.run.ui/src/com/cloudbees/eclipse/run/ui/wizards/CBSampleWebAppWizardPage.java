...
public class CBSampleWebAppWizardPage extends CBWizardPage {
  ...
  private static final String PAGE_TITLE = "Sample CloudBees project";
  private static final String PAGE_DESCRIPTION = "This wizard creates a new sample CloudBees project.";
